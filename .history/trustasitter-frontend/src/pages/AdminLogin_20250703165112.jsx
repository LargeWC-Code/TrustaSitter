...
const AdminLogin = () => {
  ...
  return (
    <main className="flex items-center justify-center min-h-screen bg-gradient-to-br from-rose-100 via-white to-rose-200">
      <div className="w-full max-w-md p-8 bg-white bg-opacity-80 backdrop-blur-md rounded-2xl shadow-2xl border border-rose-200 transition-transform transform hover:scale-[1.02]">
